...
/* [Names] */
NAME_L      = "PRAKASH";           // read from the LEFT
NAME_R      = "REYA";           // read from the RIGHT
...
MARGIN_R    = 50;                 // gap, last letter -> plate right edge.
                                  ...
                                  // (59.29mm of 342mm -> 34.7mm at 200mm).
                                  // Do NOT "balance" this against MARGIN_L.
...
// of ctrR-ctrL), so the width limit is solved directly rather than iterated.
// Without this the run fills ZONE but the outer letters hang off the back edge -
// JAMES/LEEMA reached 26.85mm on a plate that allows 22mm.
...
if (!AUTO_SIZE && SPREAD > PLATE_W/2 - EDGE + 0.01)
...
TEXT_DX = -PL_EFF/2 + MARGIN_L + RUN/2;
